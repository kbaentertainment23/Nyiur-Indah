...
export function getAppsScriptUrl(): string {
  const envUrl = (import.meta as any).env?.VITE_APPS_SCRIPT_URL || 'https://script.google.com/macros/s/AKfycbzGJ3zZZTKR7ulFN4x45rUw6hYJBNRMCkQQs3mjbJ1RlX0_08yzyNoYCKGNXQ1K0fE/exec';
